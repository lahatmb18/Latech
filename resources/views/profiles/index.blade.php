...
<div class="container">
    <div class="row ">
        ...
        <div class="col-9 pt-5">
            ...
            <div class="d-flex">
                <div class="pr-5"><strong> {{ $postCount }} </strong> publication(s)</div>
                <div class="pr-5"><strong> {{ $followersCount }} </strong> abonné(s)</div>
                <div class="pr-5"><strong> {{ $followingCount }} </strong> abonnement(s)</div>
            </div>
