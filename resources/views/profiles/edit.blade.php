            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/profile/{{ $user->username }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row ">
                            <label for="username" class="col-md-4 col-form-label text-md-right"><strong> {{ __('Prénom') }}</strong></label>
                        ...
                        <div class="form-group row ">
                            <label for="website" class="col-md-4 col-form-label text-md-right"><strong> {{ __('Site') }}</strong></label>
                        ...
                        <div class="form-group row">
                            ...
                            <label for="image" class="col-md-4 col-form-label text-md-right"><strong>Changer Profile de Photo</strong></label> 
