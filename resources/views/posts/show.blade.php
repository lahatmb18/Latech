...
<div class="container">
            ...
            <div class="card w-100">
                <div class="row no-gutters" style="height: 500px;">
                    ...
                    <div class="col-md-8 h-100">
                        <img src="{{ asset("storage/$post->image") }}" class="w-75 h-100">
                    </div>
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <p class="my-0 ml-1 text-dark"> <strong></strong></p>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <a href="/profile/{{$post->user->username}}">
                                            <img src="{{ asset($post->user->profile->getProfileImage()) }}" class="rounded-circle w-50">
                                        </a>
                                    </div>
                                    ...
                                    <div class="row my-3">
                                        <div class="col-2">
                                            <a href="/profile/{{$comment->user->username}}">
                                                <img src="{{ asset($comment->user->profile->getProfileImage()) }}" class="rounded-circle w-75">
                                            </a>
                                        </div>
                                        <div class="col-10 pl-0">
                                            <p class="m-0 text-dark">
                            ...
                            <div class="card-footer align-self-end w-100 p-0 border-top-0">
                                ...
                                <div class="py-2 px-3 border">
                                    ...
                                    {{-- Post Likes --}}
                                    @if ($post->likes > 0)
                                        <p class="m-0"><strong>{{ $post->likes }} j'aime(s)</strong></p>
                                    @endif
                                ...
                                <form action="{{ action('CommentController@store') }}" method="POST">
                                    ...
                                    <div class="form-group mb-0 text-muted">
                                        <div class="input-group is-invalid">
                                            ...
                                            <textarea class="form-control py-2 px-3" id="body" name='body' rows="1" placeholder="Ajouter un commentaire"></textarea>
    ...
    @if ($posts->count() > 0)
        ...
        <div class="more">
                <h6 class="text-muted">Autres Publications de
