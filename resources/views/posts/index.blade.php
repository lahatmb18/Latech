                ...
                @forelse ($posts as $post)
                    ...
                    <div class="card mx-auto custom-card mb-5" id="prova">
                            ...
                            <div class="card-dots">
                                ...
                                <div class="modal fade" id="post{{$post->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <ul class="list-group">
                                            <a href="#"><li class="btn list-group-item">Se Désabonner</li></a>
                                            @can('delete', $post)
                                            ...
                                            @endcan
                                            <a href="/p/{{ $post->id }}"><li class="btn list-group-item">Aller à la publication</li></a>
                                            <a href="#"><li class="btn list-group-item" data-dismiss="modal">Annuler</li></a>
                                        </ul>
                                    </div>
                                    </div>
                                </div>
                        ...
                        <div class="js-post" ondblclick="showLike(this, 'like_{{ $post->id }}')">
                            ...
                            <img class="card-img" src="{{ asset("storage/$post->image") }}" alt="post image" style="max-height: 450px">
                        </div>
                        ...
                        <div class="card-body px-3 py-2">
                            ...
                            <div class="flex-row">
                                ...
                                @if (count($post->like->where('State',true)) > 0)
                                    <h6 class="card-title">
                                        <strong>{{ count($post->like->where('State',true)) }} j'aime(s)</strong>
                                    </h6>
                                @endif
                            ...
                            <form action="{{ action('CommentController@store') }}" method="POST">
                                ...
                                <div class="form-group mb-0  text-muted">
                                    <div class="input-group is-invalid">
                                        ...
                                        <textarea class="form-control" id="body" name='body' rows="1" cols="1" placeholder="Ajouter un commentaire"></textarea>
                                        <div class="input-group-append">
                                            <button class="btn btn-md btn-outline-info" type="submit">Publier</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                @empty
                    ...
                    <div class="d-flex justify-content-center p-3 py-5 border bg-white">
                        <div class="card border-0 text-center">
                            ...
                            <div class="card-body ">
                                <h3>Pas de Publication trouvée</h3>
                                <p class="card-text text-muted">Nous n'avons trouvé aucun message, essayez de suivre quelqu'un</p>
                            </div>
                        </div>
                    </div>
            ...
            <aside class="aside col-md-4 py-3">
                <div class="position-fixed">
                    ...
                    <div class='mb-4' style="width: 300px">
                        <h6 class='text-secondary'>Suggestion d'amis</h5>
                            ...
                            <div class='suggestions py-2'>
                                <div class="d-flex align-items-center ">
                                    ...
                                    <div class='d-flex flex-column pl-3'>
                                        ...
                                        <small class="text-muted">Nouveau sur Senegram </small>
                                    </div>
                    ...
                    <!-- CopyRight -->
                    <div>
                        <span style='color: #a6b3be;'>© 2021 Senegram from Lahat</span>
                    </div>
