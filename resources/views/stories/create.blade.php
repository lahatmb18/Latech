                ...
                <div class="card-body">
                    ...
                    <form action="/stories" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="caption" class="col-md-4 col-form-label text-md-right"><strong>Légende</strong></label>

                            <div class="col-md-6">
                                <textarea type="caption" id="caption" name="caption"
                                        autocomplete="caption"  cols="30" rows="3" placeholder="Ecrire une légende..."
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="image">{{ old('image') ?? "Selectionner Photo..." }}</label>
